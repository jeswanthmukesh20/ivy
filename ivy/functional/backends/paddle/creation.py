...
def copy_array(
    ...
    *,
    ...
    new_arr = paddle.empty(x.shape, dtype=x.dtype) if 0 in x.shape else x.clone()
    return ivy.to_ivy(new_arr) if to_ivy_array else new_arr
